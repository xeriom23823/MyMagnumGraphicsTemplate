#ifndef AIR_WEAVER_DRAWABLEOBJECTS_PICKABLEOBJECT_H_
#define AIR_WEAVER_DRAWABLEOBJECTS_PICKABLEOBJECT_H_
...
public:
    explicit PickableObject(Shaders::PhongGL& shader, const Color3& color,
                            GL::Mesh& mesh,
                            Scene3D* parent,
...
#endif // AIR_WEAVER_DRAWABLEOBJECTS_PICKABLEOBJECT_H_
