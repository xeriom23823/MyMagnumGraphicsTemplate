...
namespace ImGui
{
    ...
    // Adat:
    IMGUI_API void          SetActiveID_Adat(ImGuiID id, ImGuiWindow* window);
    ...
    // Adat:
    IMGUI_API void          RenderTextClippedEx_Adat(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec4& color, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
    IMGUI_API void          RenderTextClipped_Adat(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
    IMGUI_API void          RenderFrameBorder_Adat(ImVec2 p_min, ImVec2 p_max, ImVec4 col, float rounding = 0.0f);
    ...
    // Adta:
    IMGUI_API void          RenderArrow_Adat(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float offset, float scale = 1.0f);
    ...
    // Adat:
    IMGUI_API void          TextEx_Adat(const char* text, const ImVec2& xyoffset, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    ...
    // Adat:
    IMGUI_API bool          TreeNodeBehavior_Adat(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label2, bool* bhasbeenedited, ImGuiTreeNodeFlags index, ImTextureID user_texture_id = NULL, const char* label_end = NULL, const char* labe2_end = NULL);
    IMGUI_API bool          ButtonBehavior_Adat(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags = 0);
