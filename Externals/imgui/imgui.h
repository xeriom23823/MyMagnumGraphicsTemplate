...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsCustom(ImGuiStyle* dst = NULL); // AIR Weaver
    ...
    // Adat:
    IMGUI_API void          TextColored_Adat(const ImVec4& txt_col, const ImVec2& size, const int align, const ImVec2& padding, const char* fmt, ...) IM_FMTARGS(2); // shortcut for PushStyleColor(ImGuiCol_Text, col); Text(fmt, ...); PopStyleColor();
    IMGUI_API void          TextColoredV_Adat(const ImVec4& txt_col, const ImVec2& offset, const char* fmt, va_list args)  IM_FMTLIST(2);
    ...
    // Adat:
    IMGUI_API void          Image_Adat(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& offset, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
    IMGUI_API void          RenderRectangle_Adat(const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col);
    ...
    // Adat:
    IMGUI_API bool          CollapsingHeader_Adat(const char* label, const char* label2, bool* bhasbeenedited, const int depth = 0, ImTextureID user_texture_id = NULL, ImGuiTreeNodeFlags flags = 0);
    ...
    // Adat:
    IMGUI_API void          DrawIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, bool filled, ImU32 color, ImU32 innerColor);
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_AlignRight			= 1 << 20   // Align the contents of the input box to the right
...
struct ImDrawList
{
    ...
    // Adat:
    IMGUI_API void  AddTriangleFilled_Adat(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, ImU32 col);
    ...
    // Adat:
    IMGUI_API void  PathRect_Adat(const ImVec2& rect_min, const ImVec2& rect_max, float rounding = 0.0f, ImDrawFlags flags = 0);
